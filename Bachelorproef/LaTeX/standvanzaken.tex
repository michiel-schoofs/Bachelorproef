...
\label{CBA}
 De opzet van het protocol beperkt zich niet louter tot bestandsoverdracht. Ze beschrijven zichzelf als een gedistribueerd bestandssysteem dat een alternatief bied voor de manier waarop we naar het internet kijken. Wat wordt daar echter mee bedoeld?\\
...
Volgens IPFS is er een probleem met de manier waarop er klassiek wordt gezocht naar bestanden. Er wordt namelijk altijd een derde partij vertrouwd om het juist bestand aan te leveren. Stel bijvoorbeeld onderstaand 
